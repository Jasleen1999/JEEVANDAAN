...
<div class="sidebar" ><b>
  ...
  <a href="receiver_list.php"   <?php if($active=='receiver_list') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbspReceiver List</a>
  <a href="query.php"   <?php if($active=='query') echo "class='act'"; ?>><span class="glyphicon glyphicon-check"></span>&nbsp&nbspQueries</a>
