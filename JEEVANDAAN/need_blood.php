...
<body>
      ...
      <div id="content-wrap" style="padding-bottom:50px;">
        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <h3>Check the availability of Blood Groups here</h3>
          </div>
  ...
  if (mysqli_num_rows($result) > 0) {
    ?>
    <div class= "container">
      <h1><center>List of Available Donors</center></h1>
    </div>
    <?php
    while ($row = mysqli_fetch_assoc($result)) {
?>
...
<div class="container">
    <br>
      <center>
        <a href="receiver.php" style="background-color: #f44336; color: white; padding: 15px 25px; text-align: center;text-decoration: none; display: inline-block;"><h1>Emergency?? Fill in your details here!!</h1></a>
      </center>
      <br>
    </div>
          </div>
