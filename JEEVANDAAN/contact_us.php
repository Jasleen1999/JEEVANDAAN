...
<div id="page-container" style="margin-top:20px; position: relative;min-height: 84vh;">
  ...
  <div id="content-wrap" style="padding-bottom:50px;">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <br>
        <p>
            <h4>Address :</h4>BVICAM, A-4, Paschim Vihar, Opp. Paschim Vihar (East) Metro Station, Rohtak Road, New Delhi, Delhi 110063
        </p>
        <p>
            <h4>Contact Number :</h4>7291817280
        </p>
        <p>
          <h4>  Email: </h4><a href="#">jasleen161999@gmail.com</a>
          </a></b>
        </p>
    </div>
</div>
